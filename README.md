...
| **Assinatura do Conector DJEN** | Sem ela, o sistema não busca intimação, processo nem lei |
...
ao Diário de Justiça Eletrônico Nacional, ao andamento de processo e ao texto de lei.
...
| Os três advogados de IA raciocinando sobre o que você já tem | |
...
O cálculo de prazo não está aqui: ele vem separado, pelo plugin `jurislabs-prazos`, porque
precisa se atualizar sozinho quando um tribunal publica portaria nova. O Passo 11 do
INSTALACAO.md instala.
